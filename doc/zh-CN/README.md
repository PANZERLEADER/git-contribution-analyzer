...
本目录提供 GCA 0.5.1 核心用户文档的简体中文版本。英文文档仍是原始技术契约；中文文档与其
...
- [release-0.5.1.md](release-0.5.1.md)：0.5.1 工作区迁移、身份合并和发布说明修复。
- [release-0.5.0.md](release-0.5.0.md)：0.5.0 observation-only 历史结构基线。
- [release-0.4.1.md](release-0.4.1.md)：0.4.1 CLI standalone 打包修复。
- [release-0.4.0.md](release-0.4.0.md)：0.4.0 跨平台桌面应用。
- [release-0.3.0.md](release-0.3.0.md)：0.3.0 周期趋势、时间口径和历史对比能力。
